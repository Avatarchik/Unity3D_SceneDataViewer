namespace XJ.Unity3D.GUI
{
    ...
    public class FloatGUI
    {
        ...
        public float Value
        {
            set
            {
                this.value = (float)System.Math.Round(value, GUILayout.NumberOfFloatValueDecimal);
        ...
        public string Text
        {
            set
            {
                ...
                if (this.textIsValid)
                {
                    newValue = (float)System.Math.Round(newValue, GUILayout.NumberOfFloatValueDecimal);
                    this.value = newValue;
